...
public class AnimManager : MonoBehaviour
{
    ...
    public void LevelStartAnim()
    {
        ...
        levelBG.transform.DOScale(new Vector2(1.3f, 1.3f), animSpeed).SetEase(easeType);
    }
    ...
    private IEnumerator IncreaseScaleSize(float time)
    {
        for (int i = 0; i < mainCube.Count; i++)
        {
            ...
            nextLevelButton.transform.DOScale(new Vector3(0.8f, 0.8f, 0.8f), animSpeed).SetEase(easeType);
